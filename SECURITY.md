# [PostCSS Add Block Lint](./README.md) / Security
...
Provided by [Snyk](https://snyk.io/test/github/dbtedman/postcss-add-block-lint) for validating package dependencies.

## Security Disclosure Policy

Email [dbtedman@gmail.com](mailto:dbtedman@gmail.com) with details about the security issue or raise a [GitHub Issue](https://github.com/dbtedman/postcss-add-block-lint/issues) and tag it as **Security**.
...
Look at [GitHub issues tagged **Security**](https://github.com/dbtedman/postcss-add-block-lint/labels/security).
